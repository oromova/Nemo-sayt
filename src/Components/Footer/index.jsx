      ...
      <div className='bg-gray-900 w-[full] text-white mx-auto px-4 sm:px-6 lg:px-8 py-12' data-aos='fade-up'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
          <div className='space-4'>
            ...
            <p className='text-gray-400 mt-4'>{t("Toshkent shahri, Muqimiy")} <br /> {t("ko'chasi 44-A uy")}</p>
          </div>
          <div className='space-4'>
            <h3 className='text-lg font-semibold'>{t("Bog'lanish")}</h3>
            <div className='space-2 mt-5'>
              <p className='text-gray-400'>{t("Tel: +998 95 150 00 00")}</p>
              <p className='text-gray-400 mt-1'>info@nemoavia.uz</p>
            </div>
          </div>
          <div className='space-4'>
            <h3 className='text-lg font-semibold'>{t("Ijtimoiy tarmoqlar")}</h3>
          ...
          <div className='space-4'>
            <h3 className='text-lg font-semibold'>{t("Manzil")}</h3>
            <p className='text-gray-400 mt-4'>{t("Toshkent shahri, Muqimiy")} <br /> {t("ko'chasi 44-A uy")}</p>
          </div>
        </div>
        <div className='pt-8 mt-8 border-t border-gray-800 text-center'>
          <p className='text-gray-400'>
            {t("2025 Nemo Avia trip. Barcha huquqlar himoyalangan.")}</p>
        </div>
      </div>
    </footer>
  )
